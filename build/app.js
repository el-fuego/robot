...
(function() {
  ...
  Primitive = (function() {
    ...
    Primitive.prototype.constructObject = function() {};

    Primitive.prototype.applyPosition = function() {};

    Primitive.prototype.tick = function() {};

    Primitive.prototype.getCollisionArea = function() {
      return {
        x1: 0,
        y1: 0,
        x2: 0,
    ...
    Primitive.prototype.render = function() {
      if (!this.object) {
        this.object = this.constructObject().appendTo(this.scene);
      }
  ...
  Circle = (function(_super) {
    ...
    Circle.prototype.diameter = 10;

    Circle.prototype.move = function(diffX, diffY) {
      this.centerX += diffX;
      return this.centerY += diffY;
    };
  ...
  Rectangle = (function(_super) {
    ...
    function Rectangle() {
      _ref1 = Rectangle.__super__.constructor.apply(this, arguments);
      return _ref1;
    }
    ...
    Rectangle.prototype.constructObject = function() {
      return $('<div>').css({
        position: 'absolute',
        background: '#555'
  ...
  Wall = (function(_super) {
    ...
    function Wall() {
      _ref2 = Wall.__super__.constructor.apply(this, arguments);
      return _ref2;
    }
  ...
  MovableRect = (function(_super) {
    __extends(MovableRect, _super);

    function MovableRect() {
  ...
  Robot = (function(_super) {
    ...
    function Robot() {
      _ref4 = Robot.__super__.constructor.apply(this, arguments);
      return _ref4;
    }
  ...
  physics = {
    _isBetween: function(value, rangeStart, rangeEnd) {
      return value > rangeStart && value < rangeEnd;
    },
    _coordinatesDifference: function(value, rangeStart, rangeEnd) {
      if (!this._isBetween(value, rangeStart, rangeEnd)) {
        return 0;
      }
      return Math.min(Math.abs(value - rangeStart), Math.abs(value - rangeEnd));
    },
    _areasDifference: function(firstArea, secondArea) {
      return {
        x: this._coordinatesDifference(firstArea.x1, secondArea.x1, secondArea.x2) || this._coordinatesDifference(firstArea.x2, secondArea.x1, secondArea.x2),
        y: this._coordinatesDifference(firstArea.y1, secondArea.y1, secondArea.y2) || this._coordinatesDifference(firstArea.y2, secondArea.y1, secondArea.y2)
      };
    },
    hasCollision: function(firstObject, secondObject) {
      var backDiff, diff;
